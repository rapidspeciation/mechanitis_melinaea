...
paf_table <- paf_table[paf_table$total > 500000,]
...
#broad for visibilty
#chain_table$Rend <- chain_table$Rend + 100000
#chain_table$Qend <- chain_table$Qend + 100000
...
draw.linear(directory = "plots", output = paste("synt_", taxa1, taxa2, Sys.Date(), sep = ""), 
            ...
            fileformat = "pdf", w=13,h=5, colours=c("49"="grey"))
