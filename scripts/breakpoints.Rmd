...
#if not in env
#busco_file <- read.table(file = "../output/busco_file.table")
...
br_df <- read.table("../output/comparisons/Mec/br_all_2024-06-20MecilMecMess1.table", header = T)

unique(br_df$br_origin)

write.csv(br_df[str_detect(br_df$br_origin, "MecPoly"),
                c("marker","br_origin","taxa","chr","chr_len","br_start","br_end")], 
                file = "../output/comparisons/Mec/br_polymnia_2024-06-21.csv")
```
